        ...
        $.ajax(settings).done(function (response) {
            ...
            response.data.forEach(function (res) {
                ...
                div.innerHTML = `
                  <div class="bb">  
                <div class="row">
                    <div class="col-lg-9 col-9"><a href="${res.url}">${res.titles}</a></div>
...
<div class="row">
        ...
        <div class="col-lg-1 col-3"> 
        <a href="#result"><img src="../../images/std.webp" onclick="openTest('stdd')"></a> 
        <p>STD</p>
        </div>
        <div class="col-lg-1 col-3"> 
        ...
        <div class="col-lg-1 col-3"> 
        <a href="#result"><img src="../../images/vitamins.webp" onclick="openTest('vitaminss')"></a> 
        <p>Vitamins</p>
        </div>
        <!-- <div class="col-lg-1 col-3"> 
