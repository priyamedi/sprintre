...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
        ...
        <div class="container test-icons">
            <div class="row">
            	  <div class="col-lg-1 col-3"> 
            	  		<a id="testing"><img src="../../images/kidney.webp" onclick="openTest('Abdomen')"></a>
                    <p>Kidney</p>
                </div>
                <div class="col-lg-1 col-3"> 
                		<a href="#" onclick="openTest('Abdomen')"><img src="../../images/abdomen.webp"></a>
                    <p>Stomach</p>
                </div>
                <div class="col-lg-1 col-3"> 
                	  <a href="#"><img src="../../images/allergy-disorders.webp"></a>
                    <p>Allergy</p>
                </div>
                <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/blood.webp"></a>
                    <p>Blood</p>
                </div>
               <!-- <div class="col-lg-1 col-3"> 
                ...
                <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/endocrine.webp"></a>
                    <p>Endocrine</p>
                </div>
                <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/heart.webp"></a>
                    <p>Heart</p>
                </div>
                <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/lungs.webp"></a>
                    <p>Lungs</p>
                </div>
                <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/skin.webp"></a>
                    <p>Skin</p>
                </div>
               
                <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/breast_disorders.webp"></a>
                    <p>Breast</p>
                </div>
				 <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/ear.webp"></a> 
                	<p>Ear</p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/gene.webp"></a> 
                	<p>Gene</p>
                </div>
				 <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/nerves.webp"></a> 
                	<p>Nerves</p>
                </div>
            </div> 
            <div class="row">
                ...
                <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/muscles.webp"></a> 
                	<p>Muscles</p>
                </div>
                <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/std.webp"></a> 
                	<p>STD</p>
                </div>
                <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/poisoning.webp"></a> 
                	<p>Poisoning</p>
                </div>
                <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/vitamins.webp"></a> 
                	<p>Vitamins</p>
                </div>
                
               
                <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/spleen.webp"></a> 
                	<p>Spleen</p>
                </div>
				                
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/cancer_disorder.webp"></a> 
                	<p>Cancer</p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/eyes.webp"></a> 
                	<p>Eyes</p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/liver.webp"></a> 
                	<p>Liver</p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/metabolic-disorders.webp" ></a> 
				 ...
				 <div class="col-lg-1 col-3"> 
                		<a href="#"><img src="../../images/bone-joint.webp"></a>
                    <p>Bones & <br> Joints</p>
                </div>
				 <div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/head and neck.webp"></a> 
                	<p>Head & <br> Neck</p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/urinary-system.webp"></a> 
            ...
            <div class="row">
				...
				<div class="col-lg-1 col-3 "> 
                	<a href="#"><img src="../../images/pituoitary-gland.webp" > </a> 
                	<p>Pituitary <br> Gland</p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/new-born.webp"></a> 
                	<p>New Born</p>
                </div>
				<div class="col-lg-1 col-3 "> 
                	<a href="#"><img src="../../images/reproductive-system-female.webp" ></a> 
                	<p>Uterus  </p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/male-reproductive-system.webp" ></a> 
                	<p>Testis</p>
                </div>
				
                <div class="col-lg-1 col-3 "> 
                	<a href="#"><img src="../../images/auto_immune.webp"  ></a> 
                	<p style="font-size:9px !important">Autoimmune </p>
                </div>
				<div class="col-lg-1 col-3"> 
                	<a href="#"><img src="../../images/hormones.webp" ></a> 
    ...
    <div class="section page-content-first bg-grey">
        <div class="container tests" id="Kidney">
...
function openTest(cat)
{
	 var settings = {
		var category = cat;
		alert(category);
    "url": "https://www.sprintdiagnostics.in/apis/index_new_sprint",
    "method": "POST",
    "timeout": 0,
    "headers": {
